 ...
 * @author Thuy Linh
 */
@WebServlet(name = "LoadByIDServlet", urlPatterns = {"/LoadByIDServlet"})
public class LoadByIDServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            FoodDTO foodDetail = dao.findByFoodID(foodID);
            TblCategoryDAO CateDao = new TblCategoryDAO();
            List<TblCategoryDTO> cate = CateDao.getCate();
            if(foodDetail!=null){
            ...
            log("LoadByIDServlet SQL " + e.getMessage());
        } catch (NamingException e) {
            log("LoadByIDServlet Naming " + e.getMessage());
        } finally {
