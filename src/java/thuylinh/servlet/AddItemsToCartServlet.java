...
public class AddItemsToCartServlet extends HttpServlet {
    ...
    final String SEARCH_PAGE="UrlRewritingSearch";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session.getAttribute("FULLNAME") == null) {
                ...
                FoodDTO item = dao.findByFoodID(foodID);
            ...
            log("AddItemsToCartServlet SQL " + e.getMessage());
        } catch (NamingException e) {
            log("AddItemsToCartServlet Naming " + e.getMessage());
        } finally {
